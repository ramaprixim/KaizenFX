    ...
    <div class="container pt-70 pb-40">
      <div class="col-md-3">
        <div class="widget dark">
          ...
          <p class="font-12 mt-20 mb-20">ThemeMascot is a library of corporate and business templates with predefined
            web elements which helps you to build your own site.</p>
          ...
          <ul class="list-inline">
            <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-gray mr-5"></i> <a class="text-gray"
                href="#">123-456-789</a> </li>
            <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-gray mr-5"></i> <a class="text-gray"
                href="#"><span class="__cf_email__"
                  data-cfemail="1c7f7372687d7f685c6573696e7873717d7572327f7371">[email&#160;protected]</span></a> </li>
            <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-gray mr-5"></i> <a class="text-gray"
          ...
          <div class="col-sm-6 col-md-4">
            <div class="widget dark">
              ...
              <div class="widget-subscribe">
                <h5 class="subscribe-title text-gray">To get latest news and update keep connected with us by mailing
                </h5>
                ...
                <form id="mailchimp-subscription-form2" class="newsletter-form mt-20  form-transparent" novalidate>
                  <div class="input-group">
                    <input value name="EMAIL" placeholder="Your Email" class="form-control" data-height="45px"
                      id="mce-EMAIL" style="height: 45px;" type="email">
                    <span class="input-group-btn">
                      <button data-height="45px" class="btn btn-colored btn-theme-colored2 text-white m-0"
                        type="submit"><i class="fa fa-paper-plane-o font-20"></i></button>
                    </span>
                  </div>
                </form>
